...
def games_menu_keyboard():
    ...
    builder.row(InlineKeyboardButton(
        ...
        icon_custom_emoji_id=EMOJI["guess"], style="primary"
    ))
    builder.row(InlineKeyboardButton(
...
def admin_media_keyboard():
    ...
    builder.row(InlineKeyboardButton(
        ...
        icon_custom_emoji_id=EMOJI["profile"], style="primary"
    ))
    builder.row(InlineKeyboardButton(
        text="Медиа в Игры", callback_data="admin_media_games",
        icon_custom_emoji_id=EMOJI["games"], style="primary"
    ))
    builder.row(InlineKeyboardButton(
        text="Медиа в Пополнение", callback_data="admin_media_deposit",
        icon_custom_emoji_id=EMOJI["wallet"], style="primary"
    ))
    builder.row(InlineKeyboardButton(
        text="Медиа в Вывод", callback_data="admin_media_withdraw",
        icon_custom_emoji_id=EMOJI["withdraw"], style="primary"
    ))
    builder.row(InlineKeyboardButton(
        text="Медиа в Поддержку", callback_data="admin_media_support",
        icon_custom_emoji_id=EMOJI["support"], style="default"
    ))
    builder.row(InlineKeyboardButton(
        text="Медиа в Помощь", callback_data="admin_media_help",
        icon_custom_emoji_id=EMOJI["info"], style="default"
    ))
    builder.row(InlineKeyboardButton(
...
def dice_mode_keyboard():
    ...
    for mode_data in [
        ...
        builder.row(InlineKeyboardButton(
            text=mode_data[0], callback_data=mode_data[1],
            icon_custom_emoji_id=EMOJI["dice"], style="primary"
        ))
    builder.row(InlineKeyboardButton(
...
def dice_choice_keyboard(mode: str):
    ...
    if mode == "highlow":
        ...
        for i in range(1, 7):
            builder.add(InlineKeyboardButton(text=str(i), callback_data=f"dice_num_{i}", icon_custom_emoji_id=EMOJI["dice"], style="primary"))
        builder.adjust(3)
    elif mode == "lucky":
        builder.row(
...
def guess_number_keyboard():
    ...
    builder.row(InlineKeyboardButton(
        ...
        icon_custom_emoji_id=EMOJI["guess"], style="default"
    ))
    builder.row(InlineKeyboardButton(
    ...
    builder.row(InlineKeyboardButton(
        ...
        icon_custom_emoji_id=EMOJI["guess"], style="success"
    ))
    builder.row(InlineKeyboardButton(
        text="Назад", callback_data="back_to_games",
        icon_custom_emoji_id=EMOJI["back"], style="default"
...
def play_again_keyboard(game: str):
    ...
    builder.row(InlineKeyboardButton(
        ...
        icon_custom_emoji_id=EMOJI[game], style="success"
    ))
    builder.row(InlineKeyboardButton(
