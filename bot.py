...
LZT_SHOP_ID = 2387
LZT_API_URL = "https://prod-api.lzt.market"
...
async def create_lzt_invoice(amount_rub: float, user_id: int, username: str = None):
    ...
    async with aiohttp.ClientSession() as session:
        ...
        payment_id = f"user_{user_id}_{uuid.uuid4().hex[:8]}"
        ...
        data = {
            ...
            "url_success": "https://t.me/vest_casino_bot",
        ...
        if username:
            data["required_telegram_username"] = username
        ...
        try:
            async with session.post(
                ...
                logger.info(f"LZT API Response: {response_text}")
            ...
            async with session.get(
                ...
                if resp.status == 200:
                    ...
                    if result.get("ok") and result.get("result"):
                        ...
                        return status == "paid" or status == "success"
                return False
        except Exception as e:
