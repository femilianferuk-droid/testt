...
def games_menu_keyboard():
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(
        text="Кубик", callback_data="game_dice",
    ...
    builder.row(InlineKeyboardButton(
        ...
        icon_custom_emoji_id=EMOJI["bowling"]
    ))
    builder.row(InlineKeyboardButton(
        text="Угадай число", callback_data="game_guess_number",
        icon_custom_emoji_id=EMOJI["guess"]
    ))
    builder.row(InlineKeyboardButton(
...
def admin_media_keyboard():
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(
        text="Медиа в Профиль", callback_data="admin_media_profile",
        icon_custom_emoji_id=EMOJI["profile"]
    ))
    builder.row(InlineKeyboardButton(
        text="Медиа в Игры", callback_data="admin_media_games",
        icon_custom_emoji_id=EMOJI["games"]
    ))
    builder.row(InlineKeyboardButton(
        text="Медиа в Пополнение", callback_data="admin_media_deposit",
        icon_custom_emoji_id=EMOJI["wallet"]
    ))
    builder.row(InlineKeyboardButton(
        text="Медиа в Вывод", callback_data="admin_media_withdraw",
        icon_custom_emoji_id=EMOJI["withdraw"]
    ))
    builder.row(InlineKeyboardButton(
        text="Медиа в Поддержку", callback_data="admin_media_support",
        icon_custom_emoji_id=EMOJI["support"]
    ))
    builder.row(InlineKeyboardButton(
        text="Медиа в Помощь", callback_data="admin_media_help",
        icon_custom_emoji_id=EMOJI["info"]
    ))
    builder.row(InlineKeyboardButton(
...
def dice_mode_keyboard():
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(
        text="1-3 / 4-6 (x1.85)", callback_data="dice_mode_highlow",
        icon_custom_emoji_id=EMOJI["dice"]
    ))
    builder.row(InlineKeyboardButton(
        text="Чёт / Нечет (x1.85)", callback_data="dice_mode_evenodd",
        icon_custom_emoji_id=EMOJI["dice"]
    ))
    builder.row(InlineKeyboardButton(
        text="Угадать число (x5)", callback_data="dice_mode_number",
        icon_custom_emoji_id=EMOJI["dice"]
    ))
    builder.row(InlineKeyboardButton(
        text="Два кубика: сумма 7 (x4)", callback_data="dice_mode_twodice",
        icon_custom_emoji_id=EMOJI["dice"]
    ))
    builder.row(InlineKeyboardButton(
        text="Три кубика: 10-11 (x3)", callback_data="dice_mode_threedice",
        icon_custom_emoji_id=EMOJI["dice"]
    ))
    builder.row(InlineKeyboardButton(
        text="Счастливое: 1 или 6 (x2.5)", callback_data="dice_mode_lucky",
        icon_custom_emoji_id=EMOJI["dice"]
    ))
    builder.row(InlineKeyboardButton(
...
def guess_number_keyboard():
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(
        text="1-10 (x1.5)", callback_data="guess_range_10",
        icon_custom_emoji_id=EMOJI["guess"]
    ))
    builder.row(InlineKeyboardButton(
        text="1-50 (x3)", callback_data="guess_range_50",
        icon_custom_emoji_id=EMOJI["guess"]
    ))
    builder.row(InlineKeyboardButton(
        text="1-100 (x5)", callback_data="guess_range_100",
        icon_custom_emoji_id=EMOJI["guess"]
    ))
    builder.row(InlineKeyboardButton(
        text="Назад", callback_data="back_to_games",
...
# ========== ХЕНДЛЕР ДЛЯ ОБРАБОТКИ СООБЩЕНИЙ В ИГРЕ УГАДАЙ ЧИСЛО (до обычного сообщения) ==========
...
"""
        ...
        await message.answer(text_result, parse_mode=ParseMode.HTML, reply_markup=play_again_keyboard("guess_number"))
        await state.clear()
...
async def accept_privacy_callback(callback: CallbackQuery):
    ...
    # Сразу показываем меню пополнения
    text = f"""
{e(EMOJI['wallet'])} <b>ПОПОЛНЕНИЕ БАЛАНСА</b>
...
async def handle_custom_bet(message: Message, state: FSMContext):
    # Проверяем, не в состоянии ли мы ожидания числа
    current_state = await state.get_state()
    if current_state == "GameStates:waiting_for_guess_number":
        return
